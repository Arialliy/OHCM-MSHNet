...
RUN_ROOT="$ROOT/results/step3_ohcm_light_gate/$RUN_ID"
OUT="$RUN_ROOT/$METHOD/$DATASET/seed_$SEED"
OUT_IN_CONTAINER="$ROOT_IN_CONTAINER/results/step3_ohcm_light_gate/$RUN_ID/$METHOD/$DATASET/seed_$SEED"
...
container_name="ohcm_step3_${name_method}_${name_dataset}_s${SEED}_${RUN_ID}"
